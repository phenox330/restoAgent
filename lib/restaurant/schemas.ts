...
export const restaurantSchema = z.object({
  ...
  max_capacity_lunch: z.number().min(1, "La capacité midi doit être d'au moins 1").max(1000, "Capacité maximale : 1000").optional(),
  max_capacity_dinner: z.number().min(1, "La capacité soir doit être d'au moins 1").max(1000, "Capacité maximale : 1000").optional(),
  fallback_phone: z.string().optional().nullable(),
